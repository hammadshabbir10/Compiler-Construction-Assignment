...
{
       0,    74,    74,    81,    82,    83,    84,    85,    86,    87,
      91,    92,    95,    96,    97,   103,   104,   105,   111,   112,
     118,   119
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LBRACE", "'{'",
  "RBRACE", "'}'", "LBRACKET", "'['", "RBRACKET", "']'", "COLON", "':'",
  "COMMA", "','", "STRING", "NUMBER", "FLOAT", "BOOLEAN", "NULL_TOKEN",
  "$accept", "json", "value", "elements", "object", "array", "pair",
  "pairs", YY_NULLPTR
};
...
{
      17,     7,     1,    -9,    -9,    -9,    -9,    -9,     4,    -9,
      -9,    -9,    -5,    -9,     2,    -8,     6,    -3,    -9,    -4,
       5,    -9,    -9,    -9,    17,     8,    -9,    -9,    17,    -9,
      -9,    -9,    -9
};
...
{
       0,     0,     0,     3,     4,     5,     6,     7,     0,     2,
       8,     9,     0,    13,     0,    20,     0,     0,    16,    10,
       0,     1,    14,    19,     0,     0,    12,    17,     0,    15,
      18,    21,    11
};
...
{
       9,    22,    17,    23,    21,     1,    25,    27,    12,     2,
      28,    18,    26,    13,    24,    29,     3,     4,     5,     6,
       7,     1,    14,    14,    30,     2,    32,     0,    31,     0,
       0,     0,     3,     4,     5,     6,     7
};

static const yytype_int8 yycheck[] =
{
       0,     6,     1,     1,     0,     4,    14,    10,     1,     8,
      14,    10,     6,     6,    12,    10,    15,    16,    17,    18,
      19,     4,    15,    15,    24,     8,    28,    -1,    25,    -1,
      -1,    -1,    15,    16,    17,    18,    19
};
...
{
       0,     4,     8,    15,    16,    17,    18,    19,    21,    22,
      24,    25,     1,     6,    15,    26,    27,     1,    10,    22,
      23,     0,     6,     1,    12,    14,     6,    10,    14,    10,
      22,    27,    23
};
...
#line 1151 "parser.c"
  ...
  case 4: /* value: NUMBER  */
#line 82 "parser.y"
             { (yyval.node) = create_number_node((yyvsp[0].num)); }
#line 1157 "parser.c"
    break;

  case 5: /* value: FLOAT  */
#line 83 "parser.y"
            { (yyval.node) = create_float_node((yyvsp[0].dbl)); }
#line 1163 "parser.c"
    break;

  case 6: /* value: BOOLEAN  */
#line 84 "parser.y"
              { (yyval.node) = create_boolean_node((yyvsp[0].boolean)); }
#line 1169 "parser.c"
    break;

  case 7: /* value: NULL_TOKEN  */
#line 85 "parser.y"
...
#line 1193 "parser.c"
  ...
  case 11: /* elements: value ',' elements  */
#line 92 "parser.y"
                         { (yyval.node) = append_list_node((yyvsp[-2].node), (yyvsp[0].node)); }
#line 1199 "parser.c"
    break;

  case 12: /* object: '{' pairs '}'  */
#line 95 "parser.y"
                      { (yyval.node) = create_object_node((yyvsp[-1].node)); }
#line 1205 "parser.c"
    break;

  case 13: /* object: '{' '}'  */
#line 96 "parser.y"
              { (yyval.node) = create_object_node(NULL); }
#line 1211 "parser.c"
    break;

  case 14: /* object: '{' error '}'  */
#line 97 "parser.y"
                    { 
...
#line 1220 "parser.c"
  ...
  case 15: /* array: '[' elements ']'  */
#line 103 "parser.y"
                        { (yyval.node) = create_array_node((yyvsp[-1].node)); }
#line 1226 "parser.c"
    break;
...
#line 1241 "parser.c"
  ...
  case 18: /* pair: STRING ':' value  */
#line 111 "parser.y"
                       { (yyval.node) = create_pair_node((yyvsp[-2].str), (yyvsp[0].node)); }
#line 1247 "parser.c"
    break;

  case 19: /* pair: STRING error  */
#line 112 "parser.y"
                   {
